...
import com.Asgts.awt.Color;                                           //~1108R~//+@@@@R~
import com.Asgts.awt.Font;                                            //~1108R~//+@@@@R~
//import com.Asgts.awt.Frame;                                           //~1108R~//+@@@@R~
import com.Asgts.awt.SystemColor;                                     //~1108R~//+@@@@R~
                                                                   //~1108I~
import jagoclient.Dump;

import java.io.FileInputStream;
//import java.io.FileOutputStream;	@@@@                           //~1401R~
import com.Asgts.java.FileOutputStream;                           //~1401I~//+@@@@R~
...
//            }                                                    //~@@@@R~
	...
	// Properties:
	protected //@@@@ for Asgts.rene.Global                         //+@@@@R~
