//*CID://+1A25R~:                             update#=    4;       //~1A25R~
//**************************************************************** //~1A25R~
//1A25 2013/03/25 StringParser:consideration quotation             //~1A25R~
//**************************************************************** //~1A25R~
...
{	char C[];
	...
	*/
    ...
    //********************************************                 //~1A25R~
	public String parsewordDQ()                                    //~1A25R~
	{	if (Error) return "";                                      //~1A25R~
		while (blank())                                            //~1A25R~
		{	if (!advance()) return "";                             //~1A25R~
		}                                                          //~1A25R~
    	if (C[N]!='\"')                                            //~1A25R~
        	return parseword();                                    //~1A25R~
        N++;                                                       //~1A25R~
		int n=N;                                                   //~1A25R~
		while (C[N]!='\"')                                         //~1A25R~
		{	if (!advance()) return "";                             //~1A25R~
