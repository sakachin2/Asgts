...
import static com.Asgts.gtp.AnalyzeUtil.getParameterCommand;       //+v1B6R~
import static com.Asgts.gtp.AnalyzeUtil.parseParameterLine;        //+v1B6R~
