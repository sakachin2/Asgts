...
import com.Asgts.gtp.ConstClock;                                   //+1AfmR~
import com.Asgts.gtp.TimeSettings;                                 //+1AfmR~
import com.Asgts.gtp.GoColor;                                      //+1AfmR~

import static com.Asgts.gtp.GoColor.BLACK;                         //+1AfmR~
import static com.Asgts.gtp.GoColor.WHITE;                         //+1AfmR~

import com.Asgts.gtp.GoPoint;                                      //+1AfmR~
import com.Asgts.gtp.InvalidPointException;                        //+1AfmR~
import com.Asgts.gtp.Move;                                         //+1AfmR~
import com.Asgts.gtp.PointList;                                    //+1AfmR~
import com.Asgts.gtp.StringUtil;                                   //+1AfmR~
...
public final class GtpUtil
{
    ...
    public static String getTimeSettingsCommand(TimeSettings settings)
    {
        ...
        if (Dump.Y) Dump.println("GtpUtil:getTimeSettingsCommand="+//~1AfmI~
               "time_settings " + preByoyomi + " " + byoyomi + " " //~1AfmI~
            + byoyomiMoves);                                       //~1AfmI~
    ...
    public static boolean isStateChangingCommand(String line)
    {
        ...
        return (c.equals("boardsize")
                ...
                || c.equals("genmove")
//                || c.equals(GoGui.REG_GENMOVE)                     //~1AfmR~
