//*CID://+1Ah0R~: update#=   6;                                    //~v1B6I~//+1Ah0R~
//*********************************                                //~v1B6I~
...
//      assert totalTime > 0;                                      //+1Ah0R~
    ...
    public TimeSettings(long preByoyomi, long byoyomi, int byoyomiMoves)
    {
        ...
        if (Dump.Y) Dump.println("TimeSettings preByoyomi="+preByoyomi+",byoyomi="+byoyomi+",byoyomiMoves="+byoyomiMoves);//~v1B6I~
    }
    ...
    {
    	if (Dump.Y) Dump.println("TimeSettings;parse input="+s);   //~v1B6I~
